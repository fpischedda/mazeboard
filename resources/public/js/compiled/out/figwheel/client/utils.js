...
var or__29559__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj37020 = {"detail":data};
return obj37020;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__29547__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__29547__auto__)){
var and__29547__auto____$1 = (window["CustomEvent"]);
...
var f = (function (){var pred__37027 = cljs.core._EQ_;
var expr__37028 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__37027.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__37028))){
return ((function (pred__37027,expr__37028){
return (function (p1__37021_SHARP_){
return console.warn(p1__37021_SHARP_);
});
;})(pred__37027,expr__37028))
} else {
if(cljs.core.truth_(pred__37027.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__37028))){
return ((function (pred__37027,expr__37028){
return (function (p1__37022_SHARP_){
return console.debug(p1__37022_SHARP_);
});
;})(pred__37027,expr__37028))
} else {
if(cljs.core.truth_(pred__37027.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__37028))){
return ((function (pred__37027,expr__37028){
return (function (p1__37023_SHARP_){
return console.error(p1__37023_SHARP_);
});
;})(pred__37027,expr__37028))
} else {
return ((function (pred__37027,expr__37028){
return (function (p1__37024_SHARP_){
return console.log(p1__37024_SHARP_);
});
;})(pred__37027,expr__37028))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__37031){
...
var eval_fn = cljs.core.get.call(null,map__37032__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__37034_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__37036,(0),null);
var v = cljs.core.nth.call(null,vec__37036,(1),null);
...
if(cljs.core.truth_((function (){var and__29547__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1511975273672
