...
goog.provide('mazeboardui.controllers.router');
goog.require('cljs.core');
goog.require('bidi.bidi');
if(typeof mazeboardui.controllers.router.control !== 'undefined'){
} else {
mazeboardui.controllers.router.control = (function (){var method_table__9443__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"mazeboardui.controllers.router","control"),((function (method_table__9443__auto__,prefer_table__9444__auto__,method_cache__9445__auto__,cached_hierarchy__9446__auto__,hierarchy__9447__auto__){
...
cljs.core._add_method.call(null,mazeboardui.controllers.router.control,new cljs.core.Keyword(null,"init","init",-1875481434),(function (_,p__16607,___$1){
var vec__16608 = p__16607;
var route = cljs.core.nth.call(null,vec__16608,(0),null);
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"state","state",-1988618099),route], null);
}));
cljs.core._add_method.call(null,mazeboardui.controllers.router.control,new cljs.core.Keyword(null,"push","push",799791267),(function (_,p__16611,___$1){
var vec__16612 = p__16611;
var route = cljs.core.nth.call(null,vec__16612,(0),null);
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"state","state",-1988618099),route], null);
}));
cljs.core._add_method.call(null,mazeboardui.controllers.router.control,new cljs.core.Keyword(null,"set-token","set-token",1378179451),(function (_,token,state){
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"state","state",-1988618099),state], null);
}));

//# sourceMappingURL=router.js.map?rel=1511973568267
