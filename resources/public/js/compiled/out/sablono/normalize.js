...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.call(null,(function (p__10434){
var vec__10435 = p__10434;
var _ = cljs.core.nth.call(null,vec__10435,(0),null);
...
if(((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$))) && (cljs.core.every_QMARK_.call(null,(function (p1__10438_SHARP_){
return ((p1__10438_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__10438_SHARP_ === 'string');
}),class$))){
...
return cljs.core.update_in.call(null,G__10439,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__10439;
}
});
...
var len__9667__auto___10442 = arguments.length;
var i__9668__auto___10443 = (0);
while(true){
if((i__9668__auto___10443 < len__9667__auto___10442)){
args__9674__auto__.push((arguments[i__9668__auto___10443]));

var G__10444 = (i__9668__auto___10443 + (1));
i__9668__auto___10443 = G__10444;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__9675__auto__);
});
...
var G__10441 = cljs.core.reduce.call(null,cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes))){
return cljs.core.assoc.call(null,G__10441,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec.call(null,classes));
} else {
return G__10441;
}
} else {
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq10440){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq10440));
});
...
var tag_name = cljs.core.nth.call(null,vec__10447,(0),null);
var names = cljs.core.nth.call(null,vec__10447,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css.call(null,cljs.core.some.call(null,((function (matches,vec__10447,tag_name,names){
return (function (p1__10445_SHARP_){
if(cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__10445_SHARP_))){
return p1__10445_SHARP_;
} else {
return null;
}
});})(matches,vec__10447,tag_name,names))
,names)),cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.comp.call(null,cljs.core.filter.call(null,((function (matches,vec__10447,tag_name,names){
return (function (p1__10446_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__10446_SHARP_));
});})(matches,vec__10447,tag_name,names))
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__10450){
...
var tag = first__10453;
var content = seq__10452__$1;
...
var vec__10454 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__10454,(0),null);
var id = cljs.core.nth.call(null,vec__10454,(1),null);
var class$ = cljs.core.nth.call(null,vec__10454,(2),null);
...
//# sourceMappingURL=normalize.js.map?rel=1511973559122
